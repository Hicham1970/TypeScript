...
function draftCorrection({ draftAvant, draftArrière, trim: trimUnknown, draftMilieu, distAv, distAr, lpp, lbm: lbmUnknown, distCorAv, }) {
    // Calcul du trim
...
console.log("Distance de correction du tirant d'eau avant est :" +
    draftCorrection({
        draftAvant: 3.5,
        draftArrière: 4.2,
        draftMilieu: 4.1,
